        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              ...
              <a class="nav-link active" href="{{route('profesor.index')}}">Profesor</a>
                ...
                @foreach ($profesor as $profesores)
                    <tr>
                        ...
                        <td><nav class="navbar navbar-light bg-light">
                          <a class="navbar-brand" href="{{route('profesor.edit',$profesores)}}"> <center><b>Editar</b>
                      ...
                      <td><nav class="navbar navbar-light bg-light">
                        <form action="{{route('profesor.destroy',$profesores)}}" method="POST">
                          @csrf
                          @method('delete')
